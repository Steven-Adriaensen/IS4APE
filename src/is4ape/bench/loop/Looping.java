...
public class Looping{
	...
	/*
	 * This class provides all information about an execution of the looping problem
	 */
	 ...
	 * 
	 * @param rng: random number generator used a 'input' (source of 'true' randomness) 
	 * @param theta: configuration used (list of length N)
	...
	/**
	 * @return The initial configuration used during our experiments, i.e. theta_i = 0.5 \forall i
	 */
